<?php
    ...
    $query = "SELECT c.cart_id,c.product_id,p.product_type,u.login_id,(p.product_weight-p.purchased_weight) AS weight,p.product_pricePkg 
                from cart c 
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") 
    {
        ...
        $query="SELECT (product_weight-purchased_weight) AS weight,
        ...
        else
        {
            ...
            $_SESSION['product-order']=$product_id;
    ...
    <div class="main-container">
        ...
        <form class="form-wrapper" method="POST">        
            <div class="table-row">
                ...
                <div class="text">
                    <input class="reg-field" id="reg-amount" name="amount_item" type="number">
                </div>
