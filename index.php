	...
	<body>
		<div class="nav">	
			<ul class="navbar-container" id="navbar">
				<li class="icon main"><a onclick="scroll_to_top()"><i class="fas fa-seedling"></i> ORGANO</a></li>
			...
			<div id="welcome_div">
				<div id="select_user_div">
					...
					<div id="user_type">
						...
						<div id="user_seller">
							<div class="pic"  >	
								<a href="#"><img src="img/seller.png"></a>
							</div>
							<div class="about_pic">
								<p>Sell</p>
							</div>
				...
				<div id="text_div">
					<div id="text_wrapper">
						<p>Organo aims to replace the middle man when it comes to farm produce and instead aims to connect the customer directly to the producer, at the best rates!
						</p>
					</div>
				</div>
